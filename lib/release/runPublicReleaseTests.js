...
try {
  ...
  assert.equal(valid.files.length, 18, 'public handoff must enumerate installer, SBOM, and every required evidence file/checksum');
  ...
  console.log('Public release handoff tests passed (11 cases).');
