...
const copy = {
  en: {
    ...
    welcome_body: 'RealityWarden validates AI-controlled device workflows before real hardware is touched.',
  ...
  zh: {
    ...
    welcome_body: 'RealityWarden \u4f1a\u5728\u63a5\u89e6\u771f\u5b9e\u786c\u4ef6\u4e4b\u524d\uff0c\u5148\u9a8c\u8bc1 AI \u63a7\u5236\u8bbe\u5907\u7684\u4efb\u52a1\u6d41\u7a0b\u3002',
...
const metadataValueMap: Record<string, { zh: string; en: string }> = {
  ...
  'created-for-open-reality-studio': { zh: '\u4e3a RealityWarden \u521b\u5efa', en: 'Created for RealityWarden' },
