...
assert(page.includes('serializeOpenRealityProjectFile(project)') && page.includes('saveProjectAutosave(serialized.value)'), 'Autosave must persist the complete validated v2 project, including imported assets.');
