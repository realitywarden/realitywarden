...
assert(manualImportWizard.includes("event.key === 'Escape'") && manualImportWizard.includes("event.key !== 'Tab'") && page.includes('manual-import-active'), 'Manual review modal must trap keyboard focus, support Escape, and suppress underlying Three.js overlays.');
