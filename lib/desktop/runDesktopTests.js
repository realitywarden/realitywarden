...
assert(!labConfigurator.includes('onLanguageChange') && page.includes('aria-label={language === \'zh\' ? \'界面语言\' : \'Interface language\'}'), 'Application language belongs in the global header, not device navigation.');
