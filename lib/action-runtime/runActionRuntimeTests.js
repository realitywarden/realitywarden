...
assert(
  (runner.includes('action_plans') && runner.includes('summarizeActionPlan')) ||
    (runner.includes('buildExecutionLabReport') && reportBuilder.includes('action_plans')),
  'ScenarioRunner must add action_plans to LabReport.'
);
