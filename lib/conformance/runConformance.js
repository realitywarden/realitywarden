...
function main() {
  ...
  assert(page.includes('w-[240px]') && page.includes('xl:w-[280px]') && labConfigurator.includes('w-[240px]') && labConfigurator.includes('xl:w-[280px]'), 'Header and left rail must share responsive widths without reducing the 1180px workspace contract.');
